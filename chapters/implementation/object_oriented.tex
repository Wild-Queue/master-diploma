...
\textbf{Final metric value:}
\begin{flalign*}
    & FSVI(\text{C\#}) = 0.45 \cdot C_{nat}(\text{C\#}) + 0.55 \cdot V_{enf}(\text{C\#}) = 0.45 \cdot 0 + 0.55 \cdot 0.5 &&\\
    & = 0.275 &&
\end{flalign*}
...
\begin{flalign*}
    & AE(\text{Java}) &&\\
    & = 0.2 \cdot V(\text{Java}) + 0.25 \cdot M(\text{Java}) + 0.25 \cdot I(\text{Java}) + 0.3 \cdot E(\text{Java}) &&\\
...
\begin{flalign*}
    & ISRI(\text{Java}) &&\\
    & = 0.2 \cdot H_s(\text{Java}) + 0.25 \cdot L_d(\text{Java}) + 0.3 \cdot C_p(\text{Java}) + 0.25 \cdot F_b(\text{Java}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & FSVI(\text{Java}) = 0.45 \cdot C_{nat}(\text{Java}) + 0.55 \cdot V_{enf}(\text{Java}) = 0.45 \cdot 0 + 0.55 \cdot 0.5 &&\\
    & = 0.275 &&
\end{flalign*}
...
\begin{flalign*}
    & TSSI(\text{Smalltalk}) &&\\
    & = 0.3 \cdot S_{nom}(\text{Smalltalk}) + 0.3 \cdot S_{var}(\text{Smalltalk}) + 0.4 \cdot S_{rel}(\text{Smalltalk}) &&\\
...
\begin{flalign*}
    & AE(\text{Smalltalk}) &&\\
    & = 0.2 \cdot V(\text{Smalltalk}) + 0.25 \cdot M(\text{Smalltalk}) + 0.25 \cdot I(\text{Smalltalk}) &&\\
    & \qquad + 0.3 \cdot E(\text{Smalltalk}) &&\\
...
\begin{flalign*}
    & ISRI(\text{Smalltalk}) &&\\
    & = 0.2 \cdot H_s(\text{Smalltalk}) + 0.25 \cdot L_d(\text{Smalltalk}) + 0.3 \cdot C_p(\text{Smalltalk}) &&\\
    & \qquad + 0.25 \cdot F_b(\text{Smalltalk}) &&\\
...
\begin{flalign*}
    & CRFI(\text{Smalltalk}) &&\\
    & = 0.3 \cdot D_{cls}(\text{Smalltalk}) + 0.35 \cdot T_{exp}(\text{Smalltalk}) + 0.35 \cdot I_{comp}(\text{Smalltalk}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ORCI(\text{Smalltalk}) = 0.35 \cdot S_{id}(\text{Smalltalk}) + 0.3 \cdot S_{cr}(\text{Smalltalk}) &&\\
    & \qquad + 0.35 \cdot S_{meta}(\text{Smalltalk}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & PDEI(\text{Smalltalk}) = 0.35 \cdot M_{scope}(\text{Smalltalk}) + 0.35 \cdot S_{disp}(\text{Smalltalk}) &&\\
    & \qquad + 0.3 \cdot O_{virt}(\text{Smalltalk}) &&\\
