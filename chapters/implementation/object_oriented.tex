...
\begin{flalign*}
    ...
    & \qquad = 0.3 \cdot 0.5 + 0.3 \cdot 1 + 0.4 \cdot \frac{5}{6} &&\\
    & \qquad \approx 0.7833 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Java}) = 0.3 \cdot S_{nom}(\text{Java}) + 0.3 \cdot S_{var}(\text{Java}) + 0.4 \cdot S_{rel}(\text{Java}) &&\\
    & \qquad = 0.3 \cdot 0.5 + 0.3 \cdot 0.5 + 0.4 \cdot 0.5 &&\\
    & \qquad = 0.5 &&
\end{flalign*}
