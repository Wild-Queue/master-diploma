...
\begin{flalign*}
    & \qquad TSSI(\text{C++}) = 0.3 \cdot S_{nom}(\text{C++}) + 0.3 \cdot S_{var}(\text{C++}) + 0.4 \cdot S_{rel}(\text{C++}) &&\\
    & \qquad = 0.3 \cdot 0.5 + 0.3 \cdot 0.5 + 0.4 \cdot 0 &&\\
    & \qquad = 0.3&&
\end{flalign*}

\begin{flalign*}
    & \qquad TSSI(\text{C++}) = 0.25 \cdot S_{nom}(\text{C++}) + 0.3 \cdot S_{var}(\text{C++}) + 0.45 \cdot S_{rel}(\text{C++}) &&\\
    & \qquad = 0.25 \cdot 0.5 + 0.3 \cdot 0.5 + 0.45 \cdot 0 &&\\
    & \qquad = 0.275&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad b_{strict}(\text{C++}) = 1, b_{total}(\text{C++}) = 2 &&\\
    & \qquad \Rightarrow M(\text{C++}) = 0.5&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad n_{abstraction_constructs}(\text{C++}) = 2, n_{object}(\text{C++}) = 3 &&\\
    & \qquad \Rightarrow I(\text{C++}) = \frac{2}{3} = 0.67&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{C++}) = 0.2 \cdot V(\text{C++}) + 0.25 \cdot M(\text{C++}) + 0.25 \cdot I(\text{C++}) &&\\
    & \qquad \qquad + 0.3 \cdot E(\text{C++}) &&\\
    & \qquad = 0.2 \cdot \frac{3}{7} + 0.25 \cdot 0.5 + 0.25 \cdot \frac{2}{3} + 0.3 \cdot 0 &&\\
    & \qquad \approx 0.3774&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{C++}) = 0.2 \cdot H_s(\text{C++}) + 0.25 \cdot L_d(\text{C++}) &&\\
    & \qquad \qquad + 0.3 \cdot C_p(\text{C++}) + 0.25 \cdot F_b(\text{C++}) &&\\
    & \qquad = 0.2 \cdot 0 + 0.25 \cdot 0.5 + 0.3 \cdot 0.33 + 0.25 \cdot \frac{4}{6} &&\\
    & \qquad \approx 0.3907&&
\end{flalign*}
...
\begin{flalign*}
    ...
    & \qquad = 0.35 \cdot 0 + 0.3 \cdot \frac{3}{4} + 0.35 \cdot \frac{1}{3} &&\\
    & \qquad \approx 0.3417&&
\end{flalign*}
...
\begin{flalign*}
    ...
    & \qquad = 0.35 \cdot 0.2 + 0.35 \cdot 0 + 0.3 \cdot 1 &&\\
    & \qquad = 0.37&&
\end{flalign*}
...
\begin{flalign*}
    ...
    & \qquad = 0.35 \cdot 0 + 0.25 \cdot \frac{4}{6} + 0.4 \cdot 0 &&\\
    & \qquad \approx 0.1667&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{C++}) = 0.45 \cdot C_{nat}(\text{C++}) + 0.55 \cdot V_{enf}(\text{C++}) &&\\
    & \qquad = 0.45 \cdot 0 + 0.55 \cdot 0.5 &&\\
    & \qquad = 0.275&&
\end{flalign*}
...
\begin{flalign*}
    ...
    & \qquad = 0.2 \cdot \frac{2}{7} + 0.25 \cdot 0 + 0.25 \cdot 0 + 0.3 \cdot 0 &&\\
    & \qquad \approx 0.0571&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad H_s(\text{C}) = 0, L_d(\text{C}) = 0, C_p(\text{C}) = 0, F_b(\text{C}) = 0&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad CRFI(\text{C}) = 0.3 \cdot D_{cls}(\text{C}) + 0.35 \cdot T_{exp}(\text{C}) + 0.35 \cdot I_{comp}(\text{C}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0 + 0.35 \cdot 0 &&\\
    & \qquad = 0.075&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad ORCI(\text{C}) = 0.35 \cdot S_{id}(\text{C}) + 0.3 \cdot S_{cr}(\text{C}) + 0.35 \cdot S_{meta}(\text{C}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.3 \cdot \frac{2}{4} + 0.35 \cdot 0 &&\\
    & \qquad = 0.15&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad PDEI(\text{C}) = 0.35 \cdot M_{scope}(\text{C}) + 0.35 \cdot S_{disp}(\text{C}) + 0.3 \cdot O_{virt}(\text{C}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.35 \cdot 0 + 0.3 \cdot \frac{1}{3} &&\\
    & \qquad = 0.1&&
\end{flalign*}
...
\begin{flalign*}
    & \qquad SCSI(\text{C}) = 0.35 \cdot M_{def}(\text{C}) + 0.25 \cdot S_{dens}(\text{C}) + 0.4 \cdot P_{conc}(\text{C}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.25 \cdot \frac{2}{3} + 0.4 \cdot 0 &&\\
    & \qquad \approx 0.1667&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Golang}) = 0.3 \cdot S_{nom}(\text{Golang}) + 0.3 \cdot S_{var}(\text{Golang}) &&\\
    & \qquad \qquad + 0.4 \cdot S_{rel}(\text{Golang}) &&\\
    & \qquad = 0.3 \cdot 0.5 + 0.3 \cdot 0.5 + 0.4 \cdot \frac{5}{6} &&\\
    & \qquad \approx 0.6334&&
\end{flalign*}

\begin{flalign*}
    & \qquad TSSI(\text{Golang}) = 0.25 \cdot S_{nom}(\text{Golang}) + 0.3 \cdot S_{var}(\text{Golang}) &&\\
    & \qquad \qquad + 0.45 \cdot S_{rel}(\text{Golang}) &&\\
    & \qquad = 0.25 \cdot 0.5 + 0.3 \cdot 0.5 + 0.45 \cdot \frac{5}{6} &&\\
    & \qquad \approx 0.65&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{Golang}) = 0.2 \cdot V(\text{Golang}) + 0.25 \cdot M(\text{Golang}) &&\\
    & \qquad \qquad + 0.25 \cdot I(\text{Golang}) + 0.3 \cdot E(\text{Golang}) &&\\
    & \qquad = 0.2 \cdot \frac{2}{7} + 0.25 \cdot 0.5 + 0.25 \cdot 1 + 0.3 \cdot 0 &&\\
    & \qquad \approx 0.4321&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{Golang}) = 0.2 \cdot H_s(\text{Golang}) + 0.25 \cdot L_d(\text{Golang}) &&\\
    & \qquad \qquad + 0.3 \cdot C_p(\text{Golang}) + 0.25 \cdot F_b(\text{Golang}) &&\\
    & \qquad = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot \frac{2}{6} + 0.25 \cdot \frac{4}{6} &&\\
    & \qquad \approx 0.7167&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad CRFI(\text{Golang}) = 0.3 \cdot D_{cls}(\text{Golang}) + 0.35 \cdot T_{exp}(\text{Golang}) &&\\
    & \qquad \qquad + 0.35 \cdot I_{comp}(\text{Golang}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0 + 0.35 \cdot 0.5 &&\\
    & \qquad = 0.25&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ORCI(\text{Golang}) = 0.35 \cdot S_{id}(\text{Golang}) + 0.3 \cdot S_{cr}(\text{Golang}) &&\\
    & \qquad \qquad + 0.35 \cdot S_{meta}(\text{Golang}) &&\\
    & \qquad = 0.35 \cdot \frac{5}{7} + 0.3 \cdot 0.75 + 0.35 \cdot \frac{1}{3} &&\\
    & \qquad \approx 0.5917&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad PDEI(\text{Golang}) &&\\
    & \qquad = 0.35 \cdot M_{scope}(\text{Golang}) + 0.35 \cdot S_{disp}(\text{Golang}) + 0.3 \cdot O_{virt}(\text{Golang}) &&\\
    & \qquad = 0.35 \cdot 0.2 + 0.35 \cdot 0.5 + 0.3 \cdot 0 &&\\
    & \qquad = 0.245&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad SCSI(\text{Golang}) &&\\
    & \qquad = 0.35 \cdot M_{def}(\text{Golang}) + 0.25 \cdot S_{dens}(\text{Golang}) + 0.4 \cdot P_{conc}(\text{Golang}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.25 \cdot 0 + 0.4 \cdot 0.75 = 0.3    &&
\end{flalign*}
...
\begin{flalign*}
    & \qquad n_{pre} = 0, n_{post} = 0, n_{inv} = 0 &&\\
    & \qquad C_{nat}(\text{Golang}) = \frac{0 + 0 + 0}{3} = 0&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{Golang}) = 0.45 \cdot C_{nat}(\text{Golang}) + 0.55 \cdot V_{enf}(\text{Golang}) &&\\
    & \qquad = 0.45 \cdot 0 + 0.55 \cdot 0.5 = 0.275&&
\end{flalign*}
