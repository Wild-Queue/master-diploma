...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{C++}) = 0.2 \cdot H_s(\text{C++}) + 0.25 \cdot L_d(\text{C++}) &&\\
    & \qquad + 0.3 \cdot C_p(\text{C++}) + 0.25 \cdot F_b(\text{C++}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{Golang}) = 0.2 \cdot V(\text{Golang}) + 0.25 \cdot M(\text{Golang}) &&\\
    & \qquad + 0.25 \cdot I(\text{Golang}) + 0.3 \cdot E(\text{Golang}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{Golang}) = 0.2 \cdot H_s(\text{Golang}) + 0.25 \cdot L_d(\text{Golang}) &&\\
    & \qquad + 0.3 \cdot C_p(\text{Golang}) + 0.25 \cdot F_b(\text{Golang}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & CRFI(\text{Golang}) = 0.3 \cdot D_{cls}(\text{Golang}) + 0.35 \cdot T_{exp}(\text{Golang}) &&\\
    & \qquad + 0.35 \cdot I_{comp}(\text{Golang}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ORCI(\text{Golang}) = 0.35 \cdot S_{id}(\text{Golang}) + 0.3 \cdot S_{cr}(\text{Golang}) &&\\
    & \qquad + 0.35 \cdot S_{meta}(\text{Golang}) &&\\
