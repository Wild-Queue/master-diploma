...
\begin{flalign*}
    & \qquad TSSI(\text{Zonnon}) = 0.25 \cdot S_{nom}(\text{Zonnon}) + 0.3 \cdot S_{var}(\text{Zonnon}) &&\\
    & \qquad \qquad + 0.45 \cdot S_{rel}(\text{Zonnon}) &&\\
    & \qquad = 0.25 \cdot 0.5 + 0.3 \cdot 0 + 0.45 \cdot 1 = 0.575&&
\end{flalign*}
