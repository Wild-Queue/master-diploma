...
\[
\begin{aligned}
    AE(\text{Zonnon}) = 0.2 \cdot V(\text{Zonnon}) + 0.25 \cdot M(\text{Zonnon}) + 0.25 \cdot I(\text{Zonnon}) + 0.3 \cdot E(\text{Zonnon}) \\
...
\[
\begin{aligned}
    ISRI(\text{Zonnon}) = 0.2 \cdot H_s(\text{Zonnon}) + 0.25 \cdot L_d(\text{Zonnon}) + 0.3 \cdot C_p(\text{Zonnon}) + 0.25 \cdot F_b(\text{Zonnon}) \\
...
\[
\begin{aligned}
    CRFI(\text{Zonnon}) = 0.3 \cdot D_{cls}(\text{Zonnon}) + 0.35 \cdot T_{exp}(\text{Zonnon}) + 0.35 \cdot I_{comp}(\text{Zonnon}) \\
...
\[
\begin{aligned}
    ORCI(\text{Zonnon}) = 0.35 \cdot S_{id}(\text{Zonnon}) + 0.3 \cdot S_{cr}(\text{Zonnon}) + 0.35 \cdot S_{meta}(\text{Zonnon}) \\
...
\[
\begin{aligned}
    PDEI(\text{Zonnon}) = 0.35 \cdot M_{scope}(\text{Zonnon}) + 0.35 \cdot S_{disp}(\text{Zonnon}) + 0.3 \cdot O_{virt}(\text{Zonnon})\\
...
\[
\begin{aligned}
    SCSI(\text{Zonnon}) = 0.35 \cdot M_{def}(\text{Zonnon}) + 0.25 \cdot S_{dens}(\text{Zonnon}) + 0.4 \cdot P_{conc}(\text{Zonnon}) \\
