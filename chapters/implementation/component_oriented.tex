...
\begin{flalign*}
    & TSSI(\text{Zonnon}) = 0.3 \cdot S_{nom}(\text{Zonnon}) + 0.3 \cdot S_{var}(\text{Zonnon}) + 0.4 \cdot S_{rel}(\text{Zonnon}) &&\\
    & = 0.3 \cdot 0.5 + 0.3 \cdot 0 + 0.4 \cdot 1 = 0.55&&
\end{flalign*}
...
\begin{flalign*}
    & n_{abstraction\_constructs}(\text{Zonnon})=1, n_{object}(\text{Zonnon})=2 &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{Zonnon}) = 0.2 \cdot V(\text{Zonnon}) + 0.25 \cdot M(\text{Zonnon}) + 0.25 \cdot I(\text{Zonnon}) &&\\
    & \qquad + 0.3 \cdot E(\text{Zonnon}) &&\\
    & = 0.2 \cdot \frac{3}{7} + 0.25 \cdot 0.75 + 0.25 \cdot 1 + 0.3 \cdot 1 
    \approx 0.8232&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{Zonnon}) = 0.2 \cdot H_s(\text{Zonnon}) + 0.25 \cdot L_d(\text{Zonnon}) + 0.3 \cdot C_p(\text{Zonnon}) &&\\
    & \qquad + 0.25 \cdot F_b(\text{Zonnon})  &&\\
    & = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot 0.5 + 0.25 \cdot \frac{4}{6}
    \approx 0.7667&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & CRFI(\text{Zonnon}) = 0.3 \cdot D_{cls}(\text{Zonnon}) + 0.35 \cdot T_{exp}(\text{Zonnon}) &&\\
    & \qquad + 0.35 \cdot I_{comp}(\text{Zonnon}) &&\\
    & = 0.3 \cdot 0.25 + 0.35 \cdot 0 + 0.35 \cdot 0.5 = 0.25&&
\end{flalign*}
...
\begin{flalign*}
    & T_{user}=2 \text{(value, reference)} T_{ref}=1 &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ORCI(\text{Zonnon}) = 0.35 \cdot S_{id}(\text{Zonnon}) + 0.3 \cdot S_{cr}(\text{Zonnon}) &&\\
    & \qquad + 0.35 \cdot S_{meta}(\text{Zonnon}) &&\\
    & = 0.35 \cdot 0.5 + 0.3 \cdot \frac{2}{4} + 0.35 \cdot \frac{1}{3} &&\\
    & \approx 0.4417&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & PDEI(\text{Zonnon}) = 0.35 \cdot M_{scope}(\text{Zonnon}) + 0.35 \cdot S_{disp}(\text{Zonnon}) &&\\
    & \qquad + 0.3 \cdot O_{virt}(\text{Zonnon}) &&\\
    & = 0.35 \cdot 0.2 + 0.35 \cdot 0.5 + 0.3 \cdot \frac{2}{3} &&\\
    & = 0.445&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & SCSI(\text{Zonnon}) = 0.35 \cdot M_{def}(\text{Zonnon}) + 0.25 \cdot S_{dens}(\text{Zonnon}) &&\\
    & \qquad + 0.4 \cdot P_{conc}(\text{Zonnon}) &&\\
    & = 0.35 \cdot 0 + 0.25 \cdot \frac{2}{3} + 0.4 \cdot 0.5 &&\\
    & \approx 0.3667&&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & FSVI(\text{Zonnon}) = 0.45 \cdot C_{nat}(\text{Zonnon}) + 0.55 \cdot V_{enf}(\text{Zonnon}) &&\\
    & = 0.45 \cdot \frac{2}{3} + 0.55 \cdot 0.5 = 0.575&&
\end{flalign*}
