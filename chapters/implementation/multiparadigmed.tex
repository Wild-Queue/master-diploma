...
\begin{flalign*}
    & \qquad TSSI(\text{Scala}) = 0.25 \cdot S_{nom}(\text{Scala}) + 0.3 \cdot S_{var}(\text{Scala}) + 0.45 \cdot S_{rel}(\text{Scala})&&\\
    & \qquad = 0.25 \cdot 1 + 0.3 \cdot 1 + 0.45 \cdot 0.5 &&\\
    & \qquad = 0.775 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{Scala}) = 0.2 \cdot V(\text{Scala}) + 0.25 \cdot M(\text{Scala}) + 0.25 \cdot I(\text{Scala}) &&\\
    & \qquad \qquad + 0.3 \cdot E(\text{Scala}) &&\\
    & \qquad = 0.2 \cdot \frac{6}{7} + 0.25 \cdot 0 + 0.25 \cdot \frac{2}{3} + 0.3 \cdot 0
    \approx 0.3381 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{Scala}) = 0.2 \cdot H_s(\text{Scala}) + 0.25 \cdot L_d(\text{Scala}) + 0.3 \cdot C_p(\text{Scala}) &&\\
    & \qquad \qquad + 0.25 \cdot F_b(\text{Scala}) &&\\
    & \qquad = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot \frac{4}{6} + 0.25 \cdot \frac{4}{6}
    = 0.8167 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad CRFI(\text{Scala}) = 0.3 \cdot D_{cls}(\text{Scala}) + 0.35 \cdot T_{exp}(\text{Scala}) &&\\
    & \qquad \qquad + 0.35 \cdot I_{comp}(\text{Scala}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0.75 + 0.35 \cdot 1 = 0.6875 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ORCI(\text{Scala}) = 0.35 \cdot S_{id}(\text{Scala}) + 0.3 \cdot S_{cr}(\text{Scala}) + 0.35 \cdot S_{meta}(\text{Scala}) &&\\
    & \qquad = 0.35 \cdot 1 + 0.3 \cdot \frac{3}{4} + 0.35 \cdot \frac{1}{3} \approx 0.6917 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad PDEI(\text{Scala}) = 0.35 \cdot M_{scope}(\text{Scala}) + 0.35 \cdot S_{disp}(\text{Scala}) &&\\
    & \qquad \qquad + 0.3 \cdot O_{virt}(\text{Scala}) &&\\
    & \qquad = 0.35 \cdot 0.2 + 0.35 \cdot 1 + 0.3 \cdot \frac{2}{3} = 0.62 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad SCSI(\text{Scala}) = 0.35 \cdot M_{def}(\text{Scala}) + 0.25 \cdot S_{dens}(\text{Scala}) &&\\
    & \qquad \qquad + 0.4 \cdot P_{conc}(\text{Scala}) &&\\
    & \qquad = 0.35 \cdot 0.5 + 0.25 \cdot 0.5 + 0.4 \cdot 0.25 = 0.4 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{Scala}) = 0.45 \cdot C_{nat}(\text{Scala}) + 0.55 \cdot V_{enf}(\text{Scala}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{JavaScript}) = 0.25 \cdot S_{nom}(\text{JavaScript}) + 0.3 \cdot S_{var}(\text{JavaScript}) &&\\
    & \qquad \qquad + 0.45 \cdot S_{rel}(\text{JavaScript}) &&\\
    & \qquad = 0.25 \cdot 0 + 0.3 \cdot 0 + 0.45 \cdot 0.5 = 0.225 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{JavaScript}) = 0.2 \cdot V(\text{JavaScript}) + 0.25 \cdot M(\text{JavaScript}) &&\\
    & \qquad \qquad + 0.25 \cdot I(\text{JavaScript}) + 0.3 \cdot E(\text{JavaScript}) &&\\
    & \qquad = 0.2 \cdot \frac{2}{7} + 0.25 \cdot 1 + 0.25 \cdot 0 + 0.3 \cdot 0 &&\\
    & \qquad \approx 0.3071 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{JavaScript}) = 0.2 \cdot H_s(\text{JavaScript}) + 0.25 \cdot L_d(\text{JavaScript})  &&\\
    & \qquad \qquad + 0.3 \cdot C_p(\text{JavaScript}) + 0.25 \cdot F_b(\text{JavaScript}) &&\\
    & \qquad = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot 0 + 0.25 \cdot \frac{1}{6} &&\\
    & \qquad \approx 0.4917 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad CRFI(\text{JavaScript}) = 0.3 \cdot D_{cls}(\text{JavaScript}) + 0.35 \cdot T_{exp}(\text{JavaScript})  &&\\
    & \qquad \qquad + 0.35 \cdot I_{comp}(\text{JavaScript}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0 + 0.35 \cdot 0 = 0.075 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ORCI(\text{JavaScript}) = 0.35 \cdot S_{id}(\text{JavaScript}) + 0.3 \cdot S_{cr}(\text{JavaScript})  &&\\
    & \qquad \qquad + 0.35 \cdot S_{meta}(\text{JavaScript}) &&\\
    & \qquad = 0.35 \cdot 1 + 0.3 \cdot 0.75 + 0.35 \cdot 1 = 0.925 &&
\end{flalign*}
...
The predicate-based dispatch is not a built-in language feature-conditional logic can emulate it, but there is no formal dispatch mechanism based on predicates in the specification.
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad PDEI(\text{JavaScript}) = 0.35 \cdot M_{scope}(\text{JavaScript}) + 0.35 \cdot S_{disp}(\text{JavaScript}) &&\\
    & \qquad \qquad + 0.3 \cdot O_{virt}(\text{JavaScript}) &&\\
    & \qquad = 0.35 \cdot 0.2 + 0.35 \cdot 0 + 0.3 \cdot 0 = 0.07 &&
\end{flalign*}
...
Second, JavaScript provides high-level concurrency primitives: \texttt{Promise}, \texttt{async/await}, and event-driven callbacks, which correspond to structured concurrency (task-based asynchronous computation) rather than actor-style isolation or CSP channels.
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad SCSI(\text{JavaScript}) = 0.35 \cdot M_{def}(\text{JavaScript}) + 0.25 \cdot S_{dens}(\text{JavaScript}) &&\\
    & \qquad \qquad + 0.4 \cdot P_{conc}(\text{JavaScript}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.25 \cdot 0 + 0.4 \cdot 0.25 = 0.1 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{JavaScript}) = 0.45 \cdot C_{nat}(\text{JavaScript}) + 0.55 \cdot V_{enf}(\text{JavaScript}) &&\\
    & \qquad = 0.45 \cdot 0 + 0.55 \cdot 0.5 = 0.275 &&
\end{flalign*}
...
\begin{flalign*}
    & \qquad V_{exp}(\text{Python}) = 1, V_{sound}(\text{Python}) = 0.5 &&\\
    & \qquad S_{var}(\text{Python}) = 0.75 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Python}) = 0.25 \cdot S_{nom}(\text{Python}) + 0.3 \cdot S_{var}(\text{Python}) &&\\
    & \qquad \qquad + 0.45 \cdot S_{rel}(\text{Python}) &&\\
    & \qquad = 0.25 \cdot 1 + 0.3 \cdot 0.75 + 0.45 \cdot \frac{5}{6} &&\\
    & \qquad \approx 0.85 &&
\end{flalign*}
...
\begin{flalign*}
    & \qquad n_{levels}(\text{Python}) = 3, n_{levels}(\text{C\#})=7 &&\\
    & \qquad V(\text{Python})=0.\frac{3}{7} &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{Python}) = 0.2 \cdot V(\text{Python}) + 0.25 \cdot M(\text{Python}) + 0.25 \cdot I(\text{Python}) &&\\
    & \qquad \qquad + 0.3 \cdot E(\text{Python}) &&\\
    & \qquad = 0.2 \cdot \frac{3}{7} + 0.25 \cdot 0.5 + 0.25 \cdot 1 + 0.3 \cdot 0.2 &&\\
    & \qquad \approx 0.5207 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{Python}) = 0.2 \cdot H_s(\text{Python}) + 0.25 \cdot L_d(\text{Python}) + 0.3 \cdot C_p(\text{Python}) &&\\
    & \qquad \qquad + 0.25 \cdot F_b(\text{Python}) &&\\
    & \qquad = 0.2 \cdot 0 + 0.25 \cdot 1 + 0.3 \cdot \frac{1}{6} + 0.25 \cdot \frac{1}{6} &&\\
    & \qquad \approx 0.3417 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad CRFI(\text{Python}) = 0.3 \cdot D_{cls}(\text{Python}) + 0.35 \cdot T_{exp}(\text{Python}) &&\\
    & \qquad \qquad + 0.35 \cdot I_{comp}(\text{Python}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0.25 + 0.35 \cdot 1 &&\\
    & \qquad = 0.5125 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ORCI(\text{Python}) = 0.35 \cdot S_{id}(\text{Python}) + 0.3 \cdot S_{cr}(\text{Python})  &&\\
    & \qquad \qquad + 0.35 \cdot S_{meta}(\text{Python}) &&\\
    & \qquad = 0.35 \cdot 1 + 0.3 \cdot \frac{2}{4} + 0.35 \cdot 1 &&\\
    & \qquad = 0.85 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad PDEI(\text{Python}) = 0.35 \cdot M_{scope}(\text{Python}) + 0.35 \cdot S_{disp}(\text{Python})  &&\\
    & \qquad \qquad + 0.3 \cdot O_{virt}(\text{Python}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad SCSI(\text{Python}) = 0.35 \cdot M_{def}(\text{Python}) + 0.25 \cdot S_{dens}(\text{Python})  &&\\
    & \qquad \qquad + 0.4 \cdot P_{conc}(\text{Python}) &&\\
    & \qquad = 0.35 \cdot 0 + 0.25 \cdot 0 + 0.4 \cdot 0.25 = 0.1 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{Python}) = 0.45 \cdot C_{nat}(\text{Python}) + 0.55 \cdot V_{enf}(\text{Python}) &&\\
    & \qquad = 0.45 \cdot 0 + 0.55 \cdot 0.5 = 0.275 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Ruby}) = 0.25 \cdot S_{nom}(\text{Ruby}) + 0.3 \cdot S_{var}(\text{Ruby}) + 0.45 \cdot S_{rel}(\text{Ruby}) &&\\
    & \qquad = 0.25 \cdot 0.5 + 0.3 \cdot 0 + 0.45 \cdot 0 = 0.125 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad AE(\text{Ruby}) = 0.2 \cdot V(\text{Ruby}) + 0.25 \cdot M(\text{Ruby}) + 0.25 \cdot I(\text{Ruby}) &&\\
    & \qquad \qquad + 0.3 \cdot E(\text{Ruby}) &&\\
    & \qquad = 0.2 \cdot \frac{3}{7} + 0.25 \cdot 0 + 0.25 \cdot 0.5 + 0.3 \cdot 0 &&\\
    & \qquad \approx 0.2107 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ISRI(\text{Ruby}) = 0.2 \cdot H_s(\text{Ruby}) + 0.25 \cdot L_d(\text{Ruby}) + 0.3 \cdot C_p(\text{Ruby}) &&\\
    & \qquad \qquad + 0.25 \cdot F_b(\text{Ruby}) &&\\
    & \qquad = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot 0 + 0.25 \cdot \frac{1}{6} &&\\
    & \qquad \approx 0.4917 &&
\end{flalign*}
...
Ruby does not support built-in delegation keywords. The language allows to implement delegation through \texttt{Forwardable}, \texttt{SimpleDelegator}, \texttt{method\_missing} and metaprogramming mechanisms. These tools automatically redirect method calls to the internal object and reduce the amount of boilerplate code.
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad CRFI(\text{Ruby}) = 0.3 \cdot D_{cls}(\text{Ruby}) + 0.35 \cdot T_{exp}(\text{Ruby}) + 0.35 \cdot I_{comp}(\text{Ruby}) &&\\
    & \qquad = 0.3 \cdot 0.25 + 0.35 \cdot 0.25 + 0.35 \cdot 1 &&\\
    & \qquad = 0.5125 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad ORCI(\text{Ruby}) = 0.35 \cdot S_{id}(\text{Ruby}) + 0.3 \cdot S_{cr}(\text{Ruby}) + 0.35 \cdot S_{meta}(\text{Ruby}) &&\\
    & \qquad = 0.35 \cdot 1 + 0.3 \cdot \frac{3}{4} + 0.35 \cdot 1 &&\\
    & \qquad = 0.925 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad PDEI(\text{Ruby}) = 0.35 \cdot M_{scope}(\text{Ruby}) + 0.35 \cdot S_{disp}(\text{Ruby}) &&\\
    & \qquad \qquad + 0.3 \cdot O_{virt}(\text{Ruby}) &&\\
    & \qquad = 0.35 \cdot 0.2 + 0.35 \cdot 0 + 0.3 \cdot 0 &&\\
    & \qquad = 0.07 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad SCSI(\text{Ruby}) = 0.35 \cdot M_{def}(\text{Ruby}) + 0.25 \cdot S_{dens}(\text{Ruby}) &&\\
    & \qquad \qquad + 0.4 \cdot P_{conc}(\text{Ruby}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad FSVI(\text{Ruby}) = 0.45 \cdot C_{nat}(\text{Ruby}) + 0.55 \cdot V_{enf}(\text{Ruby}) &&\\
