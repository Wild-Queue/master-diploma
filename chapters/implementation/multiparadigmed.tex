...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{Scala}) = 0.2 \cdot V(\text{Scala}) + 0.25 \cdot M(\text{Scala}) + 0.25 \cdot I(\text{Scala}) &&\\
    & \qquad + 0.3 \cdot E(\text{Scala}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{Scala}) = 0.2 \cdot H_s(\text{Scala}) + 0.25 \cdot L_d(\text{Scala}) + 0.3 \cdot C_p(\text{Scala}) &&\\
    & \qquad + 0.25 \cdot F_b(\text{Scala}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & TSSI(\text{JavaScript}) = 0.3 \cdot S_{nom}(\text{JavaScript}) + 0.3 \cdot S_{var}(\text{JavaScript}) &&\\
    & \qquad + 0.4 \cdot S_{rel}(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{JavaScript}) = 0.2 \cdot V(\text{JavaScript}) + 0.25 \cdot M(\text{JavaScript}) &&\\
    & \qquad + 0.25 \cdot I(\text{JavaScript}) + 0.3 \cdot E(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{JavaScript}) = 0.2 \cdot H_s(\text{JavaScript}) + 0.25 \cdot L_d(\text{JavaScript})  &&\\
    & + 0.3 \cdot C_p(\text{JavaScript}) + 0.25 \cdot F_b(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & CRFI(\text{JavaScript}) = 0.3 \cdot D_{cls}(\text{JavaScript}) + 0.35 \cdot T_{exp}(\text{JavaScript})  &&\\
    & \qquad + 0.35 \cdot I_{comp}(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ORCI(\text{JavaScript}) = 0.35 \cdot S_{id}(\text{JavaScript}) + 0.3 \cdot S_{cr}(\text{JavaScript})  &&\\
    & \qquad + 0.35 \cdot S_{meta}(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & PDEI(\text{JavaScript}) = 0.35 \cdot M_{scope}(\text{JavaScript}) + 0.35 \cdot S_{disp}(\text{JavaScript}) &&\\
    & \qquad + 0.3 \cdot O_{virt}(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & SCSI(\text{JavaScript}) = 0.35 \cdot M_{def}(\text{JavaScript}) + 0.25 \cdot S_{dens}(\text{JavaScript}) &&\\
    & \qquad + 0.4 \cdot P_{conc}(\text{JavaScript}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{Python}) = 0.2 \cdot V(\text{Python}) + 0.25 \cdot M(\text{Python}) + 0.25 \cdot I(\text{Python}) &&\\
    & \qquad + 0.3 \cdot E(\text{Python}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{Python}) = 0.2 \cdot H_s(\text{Python}) + 0.25 \cdot L_d(\text{Python}) + 0.3 \cdot C_p(\text{Python}) &&\\
    & \qquad + 0.25 \cdot F_b(\text{Python}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & CRFI(\text{Python}) = 0.3 \cdot D_{cls}(\text{Python}) + 0.35 \cdot T_{exp}(\text{Python}) &&\\
    & \qquad + 0.35 \cdot I_{comp}(\text{Python}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & PDEI(\text{Python}) = 0.35 \cdot M_{scope}(\text{Python}) + 0.35 \cdot S_{disp}(\text{Python})  &&\\
    & \qquad + 0.3 \cdot O_{virt}(\text{Python}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & SCSI(\text{Python}) = 0.35 \cdot M_{def}(\text{Python}) + 0.25 \cdot S_{dens}(\text{Python})  &&\\
    & \qquad + 0.4 \cdot P_{conc}(\text{Python}) &&\\
    & = 0.35 \cdot 0 + 0.25 \cdot 0 + 0.4 \cdot 0.25 = 0.1 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & AE(\text{Ruby}) = 0.2 \cdot V(\text{Ruby}) + 0.25 \cdot M(\text{Ruby}) + 0.25 \cdot I(\text{Ruby}) &&\\
    & \qquad + 0.3 \cdot E(\text{Ruby}) &&\\
...
\textbf{Final metric value:}
\begin{flalign*}
    & ISRI(\text{Ruby}) = 0.2 \cdot H_s(\text{Ruby}) + 0.25 \cdot L_d(\text{Ruby}) &&\\
    & \qquad + 0.3 \cdot C_p(\text{Ruby}) + 0.25 \cdot F_b(\text{Ruby}) &&\\
    & = 0.2 \cdot 1 + 0.25 \cdot 1 + 0.3 \cdot 0 + 0.25 \cdot \frac{1}{6} &&\\
    & \approx 0.4917 &&
\end{flalign*}
