...
\begin{flalign*}
    & \qquad TSSI(\text{Scala}) = 0.3 \cdot S_{nom}(\text{Scala}) + 0.3 \cdot S_{var}(\text{Scala}) + 0.4 \cdot S_{rel}(\text{Scala})&&\\
    & \qquad = 0.3 \cdot 1 + 0.3 \cdot 1 + 0.4 \cdot 0.5 &&\\
    & \qquad = 0.8 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{JavaScript}) = 0.3 \cdot S_{nom}(\text{JavaScript}) + 0.3 \cdot S_{var}(\text{JavaScript}) &&\\
    & \qquad \qquad + 0.4 \cdot S_{rel}(\text{JavaScript}) &&\\
    & \qquad = 0.3 \cdot 0 + 0.3 \cdot 0 + 0.4 \cdot 0.5 = 0.2 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Python}) = 0.3 \cdot S_{nom}(\text{Python}) + 0.3 \cdot S_{var}(\text{Python}) &&\\
    & \qquad \qquad + 0.4 \cdot S_{rel}(\text{Python}) &&\\
    & \qquad = 0.3 \cdot 1 + 0.3 \cdot 0.75 + 0.4 \cdot \frac{5}{6} &&\\
    & \qquad \approx 0.8583 &&
\end{flalign*}
...
\textbf{Final metric value:}
\begin{flalign*}
    & \qquad TSSI(\text{Ruby}) = 0.3 \cdot S_{nom}(\text{Ruby}) + 0.3 \cdot S_{var}(\text{Ruby}) + 0.4 \cdot S_{rel}(\text{Ruby}) &&\\
    & \qquad = 0.3 \cdot 0.5 + 0.3 \cdot 0 + 0.4 \cdot 0 = 0.15 &&
\end{flalign*}
